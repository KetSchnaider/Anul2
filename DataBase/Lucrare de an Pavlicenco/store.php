...
<body>
  ...
  <div class="site-wrap">
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.php">Acasă</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Magazin</strong></div>
        </div>
      </div>
    </div>
    <?php
          ...
          ?>
            ...
            ?>
              <div class="title-section text-center col-12">
                <h1 class="text-uppercase">Produse care V-ar putea plăcea</h1>
                <br><br>
              </div>
              <?php
              for ($i = 0; $i < $num; $i++) {
