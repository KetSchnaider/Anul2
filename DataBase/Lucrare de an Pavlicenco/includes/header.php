    ...
    <div class="search-wrap">
        <div class="container">
            ...
            <form action="store.php" method="GET">
                <input type="text" name="search" class="form-control" placeholder="Căutați cuvântul cheie și apăsați enter...">
            </form>
        </div>
    </div>
    <div class="container">
            ...
            <div class="main-nav d-none d-lg-block">
                <nav class="site-navigation text-right text-md-center" role="navigation">
                    <ul class="site-menu js-clone-nav d-none d-lg-block">
                        ...
                        <li><a href="store.php?store=all">Magazin</a></li>
                        <li class="has-children">
                            <a href="#">Categorii</a>
                            <ul class="dropdown">
                                <li><a href="store.php?cat=medicine">Medicină</a></li>
                                <li><a href="store.php?cat=self-care">Îngrijire</a></li>
                            </ul>
                        </li>
