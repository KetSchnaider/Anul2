...
<body>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0">
            ...
            <strong class="text-black">Coș</strong>
          </div>
        </div>
      </div>
    </div>
                ...
                <tbody>
                  ...
                  ?>
                        <tr>
                          ...
                          <td>MDL <?php echo $data[$i][0]['item_price'] ?></td>
                          <td><?php echo $_SESSION['cart'][$i]['quantity'] ?></td>
                          <td>MDL <?php echo ($data[$i][0]['item_price'] * $_SESSION['cart'][$i]['quantity']) ?></td>
                          <td><a href="cart.php?delete=<?php echo $data[$i][0]['item_id'] ?>" class="btn btn-primary height-auto btn-sm">elimina</a></td>
                        </tr>
                    <?php }
                    } ?>
                </tbody>
              ...
              <div class="col">
                <div class="row">
                  <div class="col-md-12 text-center border-bottom mb-5">
                    <h3 class="text-black h4 text-uppercase">Totalurile coșului</h3>
                  </div>
                </div>
                <div class="row mb-3">
                  <div class="col-md-6">
                  ...
                  <div class="col-md-6 text-right">
                    ...
                    for ($i = 0; $i < $num; $i++) {
                      if (isset($data[$i])) {
                    ?>
                        <strong class="text-black">MDL <?php echo ($data[$i][0]['item_price'] * $_SESSION['cart'][$i]['quantity']) ?></strong> <br>
                    <?php
                      }
                    }
                ...
                <div class="row mb-5">
                  ...
                  <div class="col-md-6 text-right font-weight-bold">
                    <strong class="text-black">MDL <?php echo total_price($data); ?></strong>
                  </div>
                </div>

                <div class="row">
                  <div class="col-md-6">
                    <button class="btn btn-outline-primary btn-lg btn-block" onclick="window.location='store.php'">Continua cumparaturile</button>
                  </div>
                  <br> <br>
                  <div class="col-md-6">
                    <button class="btn btn-primary btn-lg btn-block" onclick="window.location='checkout.php'">Finalizează cumpărăturile</button>
                  </div>
                </div>
              </div>
            </div>
  ...
  ?>
    <h1 style="text-align: center; color:black; ">Coșul tău este gol</h1>
