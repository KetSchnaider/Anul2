...
<body>
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            ...
            <div class="row align-items-start">
                ...
                <div class="col">
                    ...
                    <form class="d-flex" method="GET" action="customers.php">
                        ...
                        <button class="btn btn-outline-secondary" type="submit" name="search_user" value="search">Caută</button>
                    </form>
                    <br>
                </div>
            </div>
        ...
        ?>
            <br>
            <h2>Editați detaliile clientului</h2>
            <form action="customers.php" method="POST">
                ...
                <div class="form-text">Vă rugăm să introduceți e-mailul în formatul: mun/r. , Balti , str.</div>
                <br>
                <button type="submit" class="btn btn-outline-success" value="update" name="update">Trimite</button>
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <button type="button" class="btn pull-left btn-outline-warning"><a style="text-decoration: none; color:black;" href="customers.php?edit=<?php echo $data[$i]['user_id'] ?>">Editeaza</a></button>
                            </td>
                            <td>
                                <button type="button" class="btn pull-left btn-outline-danger"><a style="text-decoration: none; color:black;" href="customers.php?delete=<?php echo $data[$i]['user_id'] ?>">Sterge</a></button>
                            </td>
                        </tr>
                    <?php  }
                    ?>
