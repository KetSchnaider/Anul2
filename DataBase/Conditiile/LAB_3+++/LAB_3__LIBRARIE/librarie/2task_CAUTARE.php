...
<H1 style ="text-align:center"> CAUTARE  DATE NUME_AUTOR </H1>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") 
{
  ...
  {
    $eroarenumeautor = "Se cere a fi introdus Name_autor";
  } else 
  {
...
<?php
/* Lucrul cu comanda SELECT  pentru cautarea datelor*/
$sql_select = "SELECT * FROM autor WHERE nume_autor='$nume_autor'";
$result = mysqli_query($link,$sql_select);
$row = mysqli_fetch_array($result);
if(!empty($row))
{
//Echo "Autorul  ".$row['nume_autor']. "  este in BD:"."<br/>";
echo "<p align=center >"."Autorul ".$nume_autor." este in BD:"."</p>";
