...
<head>
	<meta charset="utf-8">
	<link rel="stylesheet" type="text/css" href="fstile.css">
	<title>Ursul pacalit de vulpe</title>
	<h1 align=center>Ursul pacalit de vulpe</h1>
	<div align=center>
...
<body>
	<div >
		<p>&emsp;&emsp;Era odată o vulpe vicleană, ca toate vulpile. Ea umblase o noapte întreagă după hrană şi nu găsise nicăiri. Făcându-se ziua albă, vulpea iese la marginea drumului şi se culcă sub o tufă, gândindu-se ce să mai facă, ca să poată găsi ceva de mâncare.</p>
		
<h1 style ="text-align:center"> TABEL DE IESIRE </H1>
	    <?php require '1task_AFISARE_TABEL_AUTOR.php'; ?>  
		
		<p>&emsp;&emsp;Şăzând vulpea cu botul întins pe labele de dinainte, îi vine miros de peşte. Atunci ea rădică puţin capul şi, uitându-se la vale, în lungul drumului, zăreşte venind un car tras de boi.
		...
		<p>&emsp;&emsp;După ce hoaţa de vulpe a aruncat o mulţime de peşte pe drum, bine…şor! sare şi ea din car şi, cu mare grabă, începe a strânge peştele de pe drum. După ce l-a strâns grămadă, îl ia, îl duce la bizunia sa şi începe a mânca, că ta…re-i mai era foame!</p>

		<p>&emsp;&emsp;Tocmai când începuse a mânca, iaca vine la dânsa ursul.
		...
		<p>&emsp;&emsp;Ursul, nemaizicând nici o vorbă, aleargă-n fuga mare la băltoaga din marginea pădurei şi-şi vâră-n apă toată coada!
